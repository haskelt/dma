...
import TaskSet from './TaskSet.js?v=0.21.3-beta';
import TaskSequence from './TaskSequence.js?v=0.21.3-beta';
import TaskFactory from './TaskFactory.js?v=0.21.3-beta';
