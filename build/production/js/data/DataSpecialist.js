...
import DataWarning from '/dma/js/errors/DataWarning.js?v=0.11.0-beta';
import DataSets from '/dma/js/data/DataSets.js?v=0.11.0-beta';
import xlsx from '/dma/js/xlsx/xlsx.js?v=0.11.0-beta';
import CryptoJS from '/dma/js/cryptojs/sha256.js?v=0.11.0-beta';
