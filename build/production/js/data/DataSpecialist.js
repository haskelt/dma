...
import DataWarning from '/dma/js/errors/DataWarning.js?v=0.19.0-beta';
import UserInputNeeded from '/dma/js/errors/UserInputNeeded.js?v=0.19.0-beta';
import errors from '/dma/js/errors/errors.js?v=0.19.0-beta';
import DataSets from '/dma/js/data/DataSets.js?v=0.19.0-beta';
import xlsx from '/dma/js/xlsx/xlsx.js?v=0.19.0-beta';
import CryptoJS from '/dma/js/cryptojs/sha256.js?v=0.19.0-beta';
import StudentSelectorDialog from '/dma/js/dialogs/StudentSelectorDialog.js?v=0.19.0-beta';
