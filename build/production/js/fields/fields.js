...
import ToggleTask from '/dma/js/fields/ToggleTask.js?v=0.18.1-beta';
import TextInputTask from '/dma/js/fields/TextInputTask.js?v=0.18.1-beta';
import MultipleChoiceTask from '/dma/js/fields/MultipleChoiceTask.js?v=0.18.1-beta';
import SelectTask from '/dma/js/fields/SelectTask.js?v=0.18.1-beta';
import SpreadsheetSelectorTask from '/dma/js/fields/SpreadsheetSelectorTask.js?v=0.18.1-beta';
import ExportButtonTask from '/dma/js/fields/ExportButtonTask.js?v=0.18.1-beta';
