...
import DataError from '/dma/js/errors/DataError.js?v=0.6.0-beta';
import Task from '/dma/js/tasks/Task.js?v=0.6.0-beta';
import DataManager from '/dma/js/data/DataManager.js?v=0.6.0-beta';
