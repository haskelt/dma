...
import ToggleTask from '/js/fields/ToggleTask.js?v=0.17.1-beta';
import TextInputTask from '/js/fields/TextInputTask.js?v=0.17.1-beta';
import MultipleChoiceTask from '/js/fields/MultipleChoiceTask.js?v=0.17.1-beta';
import SelectTask from '/js/fields/SelectTask.js?v=0.17.1-beta';
import SpreadsheetSelectorTask from '/js/fields/SpreadsheetSelectorTask.js?v=0.17.1-beta';
import ExportButtonTask from '/js/fields/ExportButtonTask.js?v=0.17.1-beta';
