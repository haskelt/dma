...
import DataWarning from '/js/errors/DataWarning.js?v=0.21.0-beta';
...
import DataSets from '/js/data/DataSets.js?v=0.21.0-beta';
import xlsx from '/js/xlsx/xlsx.js?v=0.21.0-beta';
import CryptoJS from '/js/cryptojs/sha256.js?v=0.21.0-beta';
import StudentSelectorDialog from '/js/dialogs/StudentSelectorDialog.js?v=0.21.0-beta';
