...
import CryptoJS from '/js/cryptojs/sha256.js?v=0.5.0-beta';
import DataSpecialist from '/js/data/DataSpecialist.js?v=0.5.0-beta';
import DataSets from '/js/data/DataSets.js?v=0.5.0-beta';
